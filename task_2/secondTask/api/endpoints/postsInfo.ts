import { deleteMethod, getMethod, postMethod, updateMethod } from '../apiPosts';
...
export async function getCommentsById(postId: number, expectedError?: number): Promise<IComment[]> {
    ...
    return await getMethod(`/${postId}/comments`, { postId: postId }, expectedError);}
...
export async function createNewPost(newPostObject?: IPost, expectedError?: number): Promise<IPost>  {
    ...
    return await postMethod('/', newPostObject ?? {}, expectedError);}
